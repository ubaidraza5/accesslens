...
COLUMN_ALIASES: Dict[str, List[str]] = {
    ...
    "date_granted": ["grant date", "granted date", "access granted date", "date access granted", "start date"],
    "date_last_used": ["last used", "last login", "last activity", "last access", "last used date"],
    "employee_status": ["status", "account status", "user status", "employment status"],
    "manager": ["manager name", "supervisor", "reports to", "host", "sponsor"],
}
